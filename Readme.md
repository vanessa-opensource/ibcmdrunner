...
Библиотека пишет подробный отладочный лог через [logos](https://github.com/oscript-library/logos)
в лог с именем `oscript.lib.ibcmdrunner`: командные строки запуска ibcmd/ibsrv, длительность
и коды возврата команд, установку параметров. Значения паролей в лог не выводятся.
