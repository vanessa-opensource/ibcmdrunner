...
Функция СобратьДанныеКонфигурации()
	...
	ДобавитьСекцию(ДанныеКонфигурации, "database", СобратьСекциюБазыДанных());
...
// Собрать секцию database из параметров серверной или файловой базы данных
// Возвращаемое значение:
//  Соответствие - параметры секции database
Функция СобратьСекциюБазыДанных()
